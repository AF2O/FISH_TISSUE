...
def get_instance_mask(x, y):
    ...
    return instance_mask, area, bbox

def get_per_anno(x, y, img_id, category, anno_id_check_list, project):
    ...
    per_anno_dict = {}
    instance_mask, area, bbox  = get_instance_mask(x, y)
        ...
        with open(json_file, "r", encoding="gbk") as f:
            ...
            for result in results:
                ...
                if remark in label_dict.keys():
                    ...
                    per_anno_dict, anno_id, category_id, area = get_per_anno(x, y, img_id, category, anno_id_check_list,
                                                                             project = project)
                    if area > 0:
...
if __name__ == '__main__':
    ...
    target_json_path = '/data2/Caijt/SoftTeacher/data/FISH_1102/annotations/instances_all_her2.json'
