...
data = dict(
    ...
    train=dict(
        ...
        ann_file="/data2/Caijt/SoftTeacher/data/FISH_1102/annotations/instances_all_0624_her2_single_sample.json",
        ...
        seg_prefix= "/data2/Caijt/SoftTeacher/data/FISH_1102/stuffthingmaps_Her2_0624/"),
    val=dict(
        type='FishDataset',
        classes=('a', ),
        # ann_file=
...
work_dir = './work_dirs/htc_r50_fpn_1x_FISH_Her2_0624'
cfg_name = 'htc_r50_fpn_signal_FISH_Her2_0624'
auto_resume = False
gpu_ids = [7]
