...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes = classes,
        ann_file=data_root + 'annotations/instances_all_1110.json',
        img_prefix='/data2/Caijt/SoftTeacher/data/FISH_1102/23_images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=100,
            mask_thr_binary=0.5)))
work_dir = './work_dirs/htc_r50_fpn_1x_FISH'
