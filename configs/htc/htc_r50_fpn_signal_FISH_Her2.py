...
data = dict(
    ...
    train=dict(
        type='FishDataset',
        classes = classes,
        ann_file=data_root + 'annotations/instances_all_0415_her2.json',
        ...
        seg_prefix=data_root + 'stuffthingmaps_Her2/'),
    val=dict(
        type='FishDataset',
        classes = classes,
        # ann_file=data_root + 'annotations/instances_all_her2.json',
        ann_file=data_root + 'annotations/instances_all_0415_her2.json',
        img_prefix='/data2/Caijt/SoftTeacher/data/FISH_1102/her2_images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
optimizer = dict(type='SGD', lr=0.02, momentum=0.9, weight_decay=0.0001,
                 paramwise_cfg=dict(custom_keys={'classification_branch': dict(lr_mult=0.1, decay_mult=1.0),
...
load_from = None
resume_from = None
              # "/data2/Caijt/FISH_mmdet/work_dirs/htc_r50_fpn_1x_FISH_Her2_0428/latest.pth"
    # "/data2/Caijt/SoftTeacher/work_dirs/htc_r50_fpn_1x_FISH_Her2_0217/latest.pth"
workflow = [('train', 1)]
...
work_dir = './work_dirs/htc_r50_fpn_1x_FISH_Her2_0613_lr0.1_coef_0.05'
cfg_name = 'htc_r50_fpn_signal_FISH_Her2'
# gpu_ids = range(3, 4)
