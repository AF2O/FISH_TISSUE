...
data = dict(
    ...
    train=dict(
        type='FishDataset',
        classes=('a', ),
        # ann_file='/data2/Caijt/FISH_mmdet/data/FISH_TISSUE/Annotations/instances_all_0901_her2.json',
        ann_file="/data2/Caijt/FISH_mmdet/data/FISH_TISSUE/Annotations/instances_all_0902_her2_single_sample.json",
        img_prefix="/data2/Caijt/FISH_mmdet/data/FISH_TISSUE/Her2_Images_1/",
        pipeline=[
        ...
        seg_prefix= "/data2/Caijt/FISH_mmdet/data/FISH_TISSUE/Get_Stuffthing/stuffthingmaps_Her2_0902_single/"),
    val=dict(
        type='FishDataset',
        classes=('a', ),
        # ann_file='/data2/Caijt/FISH_mmdet/data/FISH_TISSUE/Annotations/instances_all_0901_her2.json',
...
load_from = None
# resume_from = None
resume_from = "/data2/Caijt/FISH_mmdet/work_dirs/baseline_lr0.06_mul_0.2/epoch_300.pth"
workflow = [('train', 1)]
...
work_dir = './work_dirs/htc_r50_fpn_1x_FISH_Her2_0905_lr0.04_batch1'
cfg_name = 'htc_r50_fpn_signal_FISH_Her2_0905_lr0.04_batch1'
auto_resume = False
