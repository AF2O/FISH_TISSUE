...
data = dict(
    ...
    train=dict(
        ...
        classes=('a', ),
        ann_file=
        '/data2/Caijt/SoftTeacher/data/FISH_1102/annotations/instances_all_0415_her2.json',
        ...
        seg_prefix=
        '/data2/Caijt/SoftTeacher/data/FISH_1102/stuffthingmaps_Her2/'),
    val=dict(
        type='FishDataset',
        classes=('a', ),
        ann_file=
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys=dict(
            classification_branch=dict(lr_mult=1.0, decay_mult=1.0),
            regression_branch=dict(lr_mult=1.0, decay_mult=1.0))))
...
work_dir = './work_dirs/htc_r50_fpn_1x_FISH_Her2_0609_resume_from0525'
